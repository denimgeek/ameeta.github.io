...
<div id="mySidenav" class="sidenav">
  ...
  <a href="alert.php">Tutorial &nbsp;&nbsp;<img src="image/1499341542_pdf.png"></a>
  <a href="alert.php">Videos &nbsp;&nbsp;<img src="image/1499341899_youtube.png"></a>
  <a href="signup.php">Sign Up&nbsp;&nbsp;<img src="image/1499342439_2.png"</a>
  <a href="log2.php">Log In&nbsp;&nbsp;<img src="image/1499342316_Login.png"</a>
  <a href="alert.php"> Feedback&nbsp;&nbsp;<img src="image/1499342531_notepad.png"</a>
</div>

<div id="main">
 
  <span style="font-size:30px;cursor:pointer" onclick="openNav()"><img src="image/1499332904_Menu.png"</span>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="image/Best-Computer-Courses-After-Graduation-4.jpg" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img src="image/Career-Academy-Online-Training.jpg" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="image/index.jpg" alt="New york" style="width:100%;">
      </div>
   ...
   <p>Tags: 
	...
	| 
 	| <i class="icon-comment"></i> <a href="#">3 Comments</a>
   	| <i class=""></i> <a href="https://www.google.co.in/maps/place/Asansol+Engineering+College/@23.7157019,86.9489577,17z/data=!3m1!4b1!4m5!3m4!1s0x39f71f28112dc85f:0xc2814fdb4c367784!8m2!3d23.7157019!4d86.9511464">Location</a>
</p>
</center>
</body>
</html>